...
pygame.display.set_caption("Breath-Shoot")
...
pine1_img = pygame.image.load('img/background3/pine1.png').convert_alpha()
pine2_img = pygame.image.load('img/background3/pine2.png').convert_alpha()
mountain_img = pygame.image.load('img/background3/mountain.png').convert_alpha()
sky_img = pygame.image.load('img/background3/sky_cloud.png').convert_alpha()
